            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                >
                    ...
                    >
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, gap: 1 }}>
                            <Typography sx={{ width: '80px', flexShrink: 0 }} variant="body2" color="text.secondary">
                                From:
                            </Typography>
                            <TimePicker
                                value={startTimeObj}
                                onChange={handleDefaultTimeChange('default_start_time')}
                                ampm={false}
                                format="HH:mm"
                                viewRenderers={{
                                    hours: renderTimeViewClock,
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            ...
                            <TimePicker
                                value={endTimeObj}
                                onChange={handleDefaultTimeChange('default_end_time')}
                                ampm={false}
                                format="HH:mm"
                                viewRenderers={{
                                    hours: renderTimeViewClock,
