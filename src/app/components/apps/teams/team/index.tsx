      ...
      if (teamData && Array.isArray(teamData)) {
        ...
        const flattened = teamData.flatMap((team: any) => {
          ...
          return users.map((user: any) => ({
            ...
            last_worked_time: user.last_worked_time,
  ...
  const columns = [
    ...
    columnHelper.accessor((row) => row?.is_working, {
      ...
      cell: (info) => {
        ...
        const lastWorkedLabel = formatLastWorkedDate(lastWorkedDate);
        ...
        return (
          <Box>
            <Typography
              ...
              mt={0.5}
            >
              {lastWorkedLabel ? lastWorkedLabel : "-"}
            </Typography>
          </Box>
        );
      },
