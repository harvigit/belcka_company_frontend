...
interface ArchivePurchaseOrderProps {
  open: boolean;
  onClose: () => void;
  onWorkUpdated?: () => void;
...
const ArchivePurchaseOrder: React.FC<ArchivePurchaseOrderProps> = ({
  open,
  onClose,
  onWorkUpdated,
  companyId,
  ...
  const fetchProjects = useCallback(async () => {
    ...
    try {
      const res = await api.get(
        `purchase-orders/archive-list?company_id=${companyId}`,
      );
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      ...
      if (selectedItem.action === "restore") {
        const response = await api.post("purchase-orders/unarchive", payload);
...
export default ArchivePurchaseOrder;
