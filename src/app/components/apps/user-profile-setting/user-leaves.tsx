...
const UserLeaves: React.FC<UserLeaveProps> = ({
    ...
    const handleEdit = (request: any) => {
        const updatedRequest = { ...request, user_leave_id: request.id };
        ...
        >
            {user.id === userId || user.user_role_id === 1 ? (
                ...
                >
                                                ...
                                                return (
                                                    <TableCell
                                                        ...
                                                        sx={{
                                                            ...
                                                            paddingBottom: "10px",
                                                            width:
                                                                header.column.id == "select" ? 30 : "auto",
                    ...
                    {/* Approved leave calendar drawer */}
                    <Drawer
                        anchor="right"
                        open={calendarOpen}
                    ...
                    >
                        ...
                        <Stack direction="row" spacing={3} alignItems="center" mb={2}>
                            <Stack direction="row" spacing={1} alignItems="center">
                                <Box sx={{ width: 12, height: 12, borderRadius: "50%", bgcolor: LEAVE_TYPE_COLOR.paid }} />
                                    ...
                                    {selectedDateLeaves.map((leave) => (
                                        ...
                                        >
                                            <Box display="flex" justifyContent="space-between" gap={2}>
                                                ...
                                                <Chip
                                                    label={getLeaveType(leave) || leave.status_text || "Approved"}
                                                    sx={{
