...
const MapCanvas = React.memo(function MapCanvas({
    ...
    const markerPosition = selectedLocation ?? LONDON_CENTER;
    ...
    return (
        ...
        >
            <GoogleMap
                ...
                zoom={ADDRESS_ZONE_ZOOM}
                onLoad={(map) => {
                    mapRef.current = map;
                    if (selectedLocation) {
                        map.panTo(selectedLocation);
                        map.setZoom(ADDRESS_ZONE_ZOOM);
                    } else {
...
const ParentAddressAreaMap = React.memo(function ParentAddressAreaMap({
    ...
    useEffect(() => {
        ...
        if (selectedLocation) {
            ...
            mapRef.current.setZoom(ADDRESS_ZONE_ZOOM);
            return;
        }
    ...
    return (
        <Stack spacing={1.5} sx={{width: '100%', minWidth: 0}}>
            ...
            <MapCanvas
                ...
                showCircle={radius > 0 || displayRadius > 0}
